...
class NMT_AttentionImagine_Seq2Seq_Beam_V4(nn.Module):
    def __init__(self, \
                 src_size, \
                 tgt_size, \
                 im_feats_size, \
        ...
        super(NMT_AttentionImagine_Seq2Seq_Beam_V4,self).__init__()
    ...
    def forward(self,src_var,src_lengths,tgt_var,im_var,teacher_force_ratio=1.0,max_length=80, criterion_mt=None, criterion_vse=None):
        ...
        #Directly compute the shared embedding at the hidden state space
        text_embedding = l2norm(context_vec)
