...
class NMT_AttentionImagine_Seq2Seq_Beam_V5(nn.Module):
    def __init__(self, \
                 src_size, \
                 tgt_size, \
                 im_feats_size, \
        ...
        super(NMT_AttentionImagine_Seq2Seq_Beam_V5,self).__init__()
        ...
        self.vse_imagine = VSE_Imagine(self.attn_model, self.im_feats_size, self.hidden_size, self.shared_embedding_size, self.dropout_im_emb, self.dropout_txt_emb, self.activation_vse)
        #self.vse_imagine = VSE_Imagine_Mean(self.attn_model, self.im_feats_size, self.hidden_size, self.shared_embedding_size, self.dropout_im_emb, self.dropout_txt_emb, self.activation_vse)
