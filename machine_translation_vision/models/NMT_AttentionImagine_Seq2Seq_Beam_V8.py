#The VSE module is changed to VSE_Imagine_IM, where we get rid of im_embedding  but directly embed
#the context to the dimension of image. We can also test two different cases, one using the loss without 
#im-text. One using both losses. I hope this will encourage more changes from hidden states. 
#Now I switch it to removing text_embedding.
...
from ..layers import VSE_Imagine_Im
from ..layers import VSE_Imagine_Text
...
class NMT_AttentionImagine_Seq2Seq_Beam_V8(nn.Module):
    def __init__(self, \
                 src_size, \
                 tgt_size, \
                 im_feats_size, \
        ...
        super(NMT_AttentionImagine_Seq2Seq_Beam_V8,self).__init__()
        ...
        self.shared_embedding_size = self.hidden_size #This is the truth for Model_V8
        ...
        self.vse_imagine = VSE_Imagine_Text(self.attn_model, self.im_feats_size, self.hidden_size, self.shared_embedding_size, self.dropout_im_emb, self.dropout_txt_emb, self.activation_vse)
