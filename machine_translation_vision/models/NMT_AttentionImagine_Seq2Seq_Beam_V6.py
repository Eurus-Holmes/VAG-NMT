#Implement a new visual-text embedding space learning, which is the shared space between encoder hidden states, 
#decoder hidden states, and images
import torch
...
from ..layers import VSE_Imagine_Enc_Dec
...
class NMT_AttentionImagine_Seq2Seq_Beam_V6(nn.Module):
    def __init__(self, \
                 src_size, \
                 tgt_size, \
                 im_feats_size, \
        ...
        super(NMT_AttentionImagine_Seq2Seq_Beam_V6,self).__init__()
        ...
        self.vse_imagine = VSE_Imagine_Enc_Dec(self.attn_model,self.im_feats_size, self.hidden_size, self.shared_embedding_size, self.dropout_im_emb, self.dropout_txt_emb, self.activation_vse)
