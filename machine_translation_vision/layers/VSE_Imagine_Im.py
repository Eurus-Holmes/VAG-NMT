#Implement the VSE module such that we directly embed the shared space to image dimension without im_embedding.
import torch
...
class VSE_Imagine_Im(nn.Module):
    def __init__(self,attn_type,\
                ...
                dropout_txt_emb=0.0, \
                activation_vse = True):
        super(VSE_Imagine_Im,self).__init__()
